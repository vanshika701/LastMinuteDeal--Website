...
import { CreditCard, Wallet, ChevronDown, ArrowLeft, Shield, Star } from "lucide-react";
...
export default function CheckoutPage({ params }: Props) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    router.push(`/booking-confirmed?restaurant=${restaurant.id}&total=${total}`);
  };
      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          <p className="text-gray-500 mb-8">
            Secure {restaurant.name} for your upcoming stay.
          </p>
            ...
            <div className="flex flex-col lg:flex-row gap-10">
              ...
              <div className="flex-1 space-y-8">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                  ...
                  <div className="flex items-start gap-3 mt-5 bg-blue-50 rounded-xl p-4">
                    ...
                    <p className="text-xs text-blue-700 leading-relaxed">
                      ...
                      processed. We never store your CVV or full card details.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <Link
                    href={`/buffet-deals/${restaurant.id}`}
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center gap-1 text-gray-500 text-sm mb-5">
                      <span>👥</span>
                      <span>
                        {restaurant.maxGuests} Guests · {restaurant.tables}{" "}
                        Table
                      </span>
                    </div>
                    ...
                    <div className="space-y-2 text-sm border-t border-gray-100 pt-4">
                      <div className="flex justify-between text-gray-600">
                        <span>
                          1 Table × ₹{restaurant.price.toLocaleString()}
                        </span>
                      ...
                      {restaurant.touristTax > 0 && (
                        <div className="flex justify-between text-gray-600">
                          <span>Tourist Tax</span>
                          <span>₹{restaurant.touristTax}</span>
                        </div>
                      )}
                    ...
                    <div className="flex items-center gap-2 mt-4 bg-orange-50 rounded-xl p-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-orange-500">
                          You&apos;re saving ₹2,000 on this deal
                        </p>
                      </div>
                    </div>
                  </div>
